...
const FAQS: FaqItem[] = [
  // ─── general (운영 정보) ───
  {
    ...
    answer:
      '월·화·목·금은 오전 10시부터 밤 20시까지 야간진료를 합니다.\n토요일·일요일·공휴일은 오전 10시부터 오후 6시까지 진료해요.\n수요일은 정기휴무이고, 점심시간(오후 1시~2시)에는 휴진합니다.\n워킹맘·맞벌이 부부도 부담 없이 오실 수 있어요.',
    tags: ['시간', '운영'],
  },
  {
    category: 'general',
  ...
  },
  {
    ...
    question: '전화번호 알려주세요',
    answer:
      '전화 문의는 02-433-5275 입니다.\n진료시간 (월·화·목·금 10~20시 / 토·일·공휴일 10~18시) 내에 받습니다.\n수요일은 정기휴무이고, 점심시간(13~14시)은 부재중일 수 있어요.',
    tags: ['전화'],
  },
  {
    category: 'general',
  ...
  },
  {
    ...
    question: '휴진일 있나요?',
    answer:
      '매주 수요일은 정기휴무입니다. 그 외 토·일·공휴일에도 정상 진료해요.\n별도 휴진일이 생기는 경우는 홈페이지 또는 02-433-5275로 미리 안내드립니다.',
    tags: ['휴진'],
  },
  {
    category: 'general',
  ...
  // ─── emergency (응급·화상·발열) ───
  {
    ...
    answer:
      '소아 화상은 깊이·면적 평가와 흉터 관리까지 종합 치료가 필요해서 화상 전문병원에서 진료받으시는 것이 가장 안전해요.\n\n응급 처치: 흐르는 시원한 물(20도 안팎)에 10~20분 환부를 식혀주세요. 얼음·너무 찬물은 피하고, 물집은 절대 터뜨리지 마세요. 깨끗한 거즈로 가볍게 덮습니다.\n\n그 후 즉시 화상 전문병원으로 이동해 주세요. 가까운 곳 예시:\n- 한림대학교 한강성심병원 (영등포구, 화상센터)\n- 베스티안병원 (강남)\n- 한일병원 화상센터 (도봉구)\n\n호흡곤란·의식저하·심한 출혈이 있으면 119를 먼저 부르세요. 엠코소아과는 화상은 직접 진료하지 않으니 양해 부탁드립니다.',
    tags: ['화상', '전문병원'],
  },
  {
    category: 'emergency',
